                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal form-submit-event"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="support_number">Support Number <span
                                                class='text-danger text-xs'>*</span></label>
                                        <input type="number" class="form-control" name="support_number"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                <label for="logo">Logo <span
                                                        class='text-danger text-xs'>*</span><small>(Recommended Size :
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="card-body">
                                            <input type="checkbox" name="is_version_system_on"
                                    ...
                                    <div class="form-group area_wise_delivery_charge <?= $class ?>">
                                        <label for="area_wise_delivery_charge">Area Wise Delivery Charge</label>
                                        <div class="card-body">
                                            <input type="checkbox" name="area_wise_delivery_charge"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="minimum_cart_amt">Minimum Cart Amount(<?= $currency ?>) <span
                                                class='text-danger text-xs'>*</span></label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="max_items_cart"
                                            ...
                                            placeholder='Maximum Items Allowed In Cart' min='0' />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="max_items_cart"> Low stock limit <small>(Product will be considered
                                                as low stock)</small> </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="delivery_boy_bonus_percentage"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12">
                                        ...
                                        <div class="card-body">
                                            <input type="checkbox" name="is_delivery_boy_otp_setting_on"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label for="cart_btn_on_list"> Enable Cart Button on Products List view?
                                        </label>
                                        <div class="card-body">
                                            <input type="checkbox" name="cart_btn_on_list"
                                                <?= (isset($settings['cart_btn_on_list']) && $settings['cart_btn_on_list'] == '1') ? 'Checked' : ''  ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="expand_product_images"> Expand Product Images? <small>( Image will
                                                be stretched in the product image boxes )</small> </label>
                                        <div class="card-body">
                                            <input type="checkbox" name="expand_product_images"
                                                <?= (isset($settings['expand_product_images']) && $settings['expand_product_images'] == '1') ? 'Checked' : ''  ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="tax_name">Tax Name <small>( This will be visible on your invoice
                                                )</small></label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="checkbox" name="google_login" class="mr-3"
                                                <?= (isset($settings['google_login']) && $settings['google_login'] == '1') ? 'Checked' : ''  ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">

                                            <label for="cart_btn_on_list"> Facebook </label>
                                            <input type="checkbox" name="facebook_login"
                                                <?= (isset($settings['facebook_login']) && $settings['facebook_login'] == '1') ? 'Checked' : ''  ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">

                                            <label for="cart_btn_on_list"> Apple </label>
                                            <input type="checkbox" name="apple_login"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="card-body">
                                            <input type="checkbox" name="is_refer_earn_on"
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="min_refer_earn_order_amount"> Minimum Refer & Earn Order Amount
                                            (<?= $currency ?>) </label>
                                        <input type="text" name="min_refer_earn_order_amount" class="form-control"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="refer_earn_bonus"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="refer_earn_method" class="form-control">
                                            ...
                                            <option value="percentage"
                                                <?= (isset($settings['refer_earn_method']) && $settings['refer_earn_method'] == "percentage") ? "selected" : "" ?>>
                                                Percentage</option>
                                            <option value="amount"
                                                <?= (isset($settings['refer_earn_method']) && $settings['refer_earn_method'] == "amount") ? "selected" : "" ?>>
                                                Amount</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="max_refer_earn_amount">Maximum Refer & Earn Amount
                                            (<?= $currency ?>)</label>
                                        <input type="text" class="form-control" name="max_refer_earn_amount"
                                            value="<?= (isset($settings['max_refer_earn_amount'])) ? $settings['max_refer_earn_amount'] : '' ?>"
                                            placeholder='Maximum Refer & Earn Bonus Amount' />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="refer_earn_bonus_times">Number of times Bonus to be given to the
                                            customer</label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="card-body">
                                            <input type="checkbox" name="welcome_wallet_balance_on"
                                                <?= (isset($settings['welcome_wallet_balance_on']) && $settings['welcome_wallet_balance_on'] == '1') ? 'Checked' : ''  ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="wallet_balance_amount"> Wallet Balance Amount (<?= $currency ?>)
                                        </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <div class="form-group col-md-12 d-flex">
                                            <label class="mb-2" for="allow_order_attachments"> Allow Upload Order
                                                Attachment? </label>
                                            <div class="mx-5">
                                                ...
                                                <a class="toggle form-switch  mr-1 mb-1" title="Deactivate"
                                                    href="javascript:void(0)"> <input type="checkbox"
                                                        ...
                                                        name="allow_order_attachments"
                                                        <?= (isset($settings['allow_order_attachments']) && $settings['allow_order_attachments'] == '1') ? 'Checked' : ''  ?>
                                                        data-bootstrap-switch data-off-color="danger"
                                                        data-on-color="success" /></a>
                                            </div>
                                        </div>

                                        <div class="form-group col-md-12 mt-3">
                                            <label class="mb-2" for="upload_limit"> Maximum upload limit </label>
                                            <input type="number" min="0" name="upload_limit" min="1"
                                                class="form-control mb-2"
                                                value="<?= (isset($settings['upload_limit']) && $settings['upload_limit'] != '') ? $settings['upload_limit'] : ''  ?>"
                                                max="10" placeholder="Maximum upload limit" />
                                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="supported_locals" class="form-control">
                                        ...
                                        foreach ($supported_methods as $key => $value) {
                                            $text = "$key - $value "; ?>
                                        <option value="<?= $key ?>"
                                            <?= (isset($settings['supported_locals']) && !empty($settings['supported_locals']) && $key == $settings['supported_locals']) ? "selected" : "" ?>>
                                            <?= $key . ' - ' . $value ?></option>
                                        <?php  }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="currency">Store Currency ( Symbol or Code - $ or USD - Anyone ) <span
                                            class='text-danger text-xs'>*</span></label>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="decimal_point" class="form-control">
                                        ...
                                        foreach ($decimal_points as $key => $value) {
                                            $text = "$key - $value "; ?>
                                        <option value="<?= $key ?>"
                                            <?= (isset($settings['decimal_point']) && !empty($settings['decimal_point']) && $key == $settings['decimal_point']) ? "selected" : "" ?>>
                                            <?= $value ?></option>
                                        <?php  }
                                        ?>
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <div class="card-body">
                                        <input type="checkbox" name="is_single_seller_order"
                                            <?= (isset($settings['is_single_seller_order']) && $settings['is_single_seller_order'] == '1') ? 'Checked' : ''  ?>
                                            data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                </div>
                            </div>
                            <h4>Maintenance Mode</h4><small>(If you Enable Maintenance Mode of App your App Will be in
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="card-body pl-0">
                                        <input type="checkbox" name="is_customer_app_under_maintenance"
                                    ...
                                    <div class="card-body pl-0">
                                        <textarea type="text" class="form-control" id="message_for_customer_app"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="card-body pl-0">
                                        <input type="checkbox" name="is_seller_app_under_maintenance"
                                    ...
                                    <div class="card-body pl-0">
                                        <textarea type="text" class="form-control" id="message_for_seller_app"
                                            placeholder="Message for Seller App"
                                            name="message_for_seller_app"><?= isset($settings['message_for_seller_app']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['message_for_seller_app'])) : ""; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="is_delivery_boy_app_under_maintenance"> Delivery boy App</label>
                                    <div class="card-body pl-0">
                                        <input type="checkbox" name="is_delivery_boy_app_under_maintenance"
                                    ...
                                    <div class="card-body pl-0">
                                        <textarea type="text" class="form-control" id="message_for_delivery_boy_app"
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    <label for="app_name">Cron Job URL <span class='text-danger text-xs'>*</span>
                                        <small>(Set this URL at your server cron job list for "once a
                                            day")</small></label>
                                    <a class="btn btn-xs btn-primary text-white mb-2" data-toggle="modal"
                                        data-target="#howItWorksModal" title="How it works">How seller commission
                                        works?</a>
                                    <input type="text" class="form-control" name="app_name"
                                        value="<?= base_url('admin/cron-job/settle-seller-commission') ?>" disabled />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    <label for="app_name">Add Promo Code Discount URL <span
                                            class='text-danger text-xs'>*</span> <small>(Set this URL at your server
                                            cron job list for "once a day")</small></label>
                                    <a class="btn btn-xs btn-primary text-white mb-2" data-toggle="modal"
                                        data-target="#howItWorksModal1" title="How it works">How Promo Code Discount
                                        works?</a>
                                    <input type="text" class="form-control" name="app_name"
                                        value="<?= base_url('admin/cron_job/settle_cashback_discount') ?>" disabled />
                                </div>
                            </div>
                                ...
                                <div class="modal-body ">
                                    <ol>
                                        ...
                                        <li> Formula for Add Promo Code Discount is <b>Sub total (Excluding delivery
                                                charge) - promo code discount percentage / Amount</b> </li>

                                        <li> For example sub total is 1300 and promo code discount is 100 then 1300 -
                                            100 = 1200 so 100 will get credited into Users's wallet </li>

                                        <li> If Order status is delivered And Return Policy is expired then only users
                                            will get Promo Code Discount. </li>

                                        <li> Ex - 1. Order placed on 10-Sep-22 and return policy days are set to 1 so
                                            10-Sep + 1 days = 11-Sep Promo code discount will get credited on 11-Sep-22
                                            at 12:00 AM (Mid night) </li>

                                        <li> If Promo Code Discount doesn't works make sure cron job is set properly and
                                            it is working. If you don't know how to set cron job for once in a day
                                            please take help of server support or do search for it. </li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="howItWorksModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel">How seller commission will get credited?
                                    </h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            Formula for seller commision is <b>Sub total (Excluding delivery charge) /
                                                100 * seller commission percentage</b>
                                        </li>
                                        <li>
                                            For example sub total is 1378 and seller commission is 20% then 1378 / 100 X
                                            20 = 275.6 so 1378 - 275.6 = 1102.4 will get credited into seller's wallet
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            11-Aug + 0 days = 11-Aug seller commission will get credited on 12-Aug-21 at
                                            12:00 AM (Mid night)
                                        </li>
                                        <li>
                                            Ex - 2. Order placed on 11-Aug-21 and product return days are set to 7 so
                                            11-Aug + 7 days = 18-Aug seller commission will get credited on 19-Aug-21 at
                                            12:00 AM (Mid night)
                                        </li>
                                        <li>
                                            If seller commission doesn't works make sure cron job is set properly and it
                                            is working. If you don't know how to set cron job for once in a day please
                                            take help of server support or do search for it.
                                        </li>
                                    </ol>
                                </div>
                            </div>
