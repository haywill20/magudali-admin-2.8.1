                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea" id="mail_msg"
                                            ...
                                            <form class="form-horizontal " id="shiprocket_order_parcel_form" action=""
                                                ...
                                                <div class="card-body pad">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="total_order_items"
                                                            id="total_order_items"
                                                    ...
                                                    <div class="mt-1 p-2 bg-danger text-white rounded">
                                                        <p><b>Note:</b> Make your pickup location associated with the
                                                            order is verified from <a
                                                                ...
                                                                target="_blank"
                                                                style="text-decoration: underline;color: white;"> admin
                                                                panel </a>. If it is not verified you will not be able
                                                            to generate AWB later on.</p>
                                                    </div>
                                                    <div class="form-group row mt-4">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                placeholder="Pickup Location" value="" readonly />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mt-4">
                                                        <div class="col-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                name="parcel_weight" placeholder="Parcel Weight"
                                                                id="parcel_weight" value="" step=".01">
                                                        </div>
                                                        <div class="col-3">
                                                            <label for="parcel_height"
                                                                ...
                                                                <small>(cms)</small> <span
                                                                    class='text-danger text-xs'>*</span></label>
                                                            <input type="number" class="form-control"
                                                                name="parcel_height" placeholder="Parcel Height"
                                                                id="parcel_height" value="" min="1">
                                                        </div>
                                                        <div class="col-3">
                                                            <label for="parcel_breadth"
                                                                ...
                                                                <small>(cms)</small> <span
                                                                    class='text-danger text-xs'>*</span></label>
                                                            <input type="number" class="form-control"
                                                                name="parcel_breadth" placeholder="Parcel Breadth"
                                                                id="parcel_breadth" value="" min="1">
                                                        </div>
                                                        <div class="col-3">
                                                            <label for="parcel_length"
                                                                ...
                                                                <small>(cms)</small> <span
                                                                    class='text-danger text-xs'>*</span></label>
                                                            <input type="number" class="form-control"
                                                                name="parcel_length" placeholder="Parcel Length"
                                                                id="parcel_length" value="" min="1">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-success create_shiprocket_parcel">Create
                                                        Order</button>
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-info">
                                            ...
                                            <form class="form-horizontal " id="edit_transaction_form"
                                                action="<?= base_url('admin/orders/edit_transactions/'); ?>"
                                                method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "Account Holder Person : " . $order_detls[0]['uname'] . " | Order Recipient Person :  " . $order_detls[0]['user_name']; ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <p>
                                            <lable class="badge badge-success" style="font-size:13px;">Select status and
                                                radio button of seller which you want to update</lable>
                                        </p>
                                        <div class="row">
                                            <div class="col-md-4 ">
                                            ...
                                            <div class="col-md-4">
                                                <a href="javascript:void(0);" title="Bulk Update"
                                                    class="btn btn-primary col-sm-12 col-md-12 update_status_admin_bulk mr-1">
                                                    Update
                                                </a>
                                            </div>
                                        </div>
                                        <p>
                                            <lable class="badge badge-warning mt-4" style="font-size:13px;">Note :
                                                Select square box of item only when you want to update it as cancelled
                                                or returned.</lable>
                                        </p>
                                        ...
                                        <p>
                                            <lable class="badge badge-success " style="font-size:13px;">Select status,
                                                delivery boy and radio button of seller which you want to update</lable>
                                        </p>
                                        <?php
                                        ...
                                        <div class="d-flex delivery_boy ">
                                            <div class="col-md-3">
                                                <select name="status" class="form-control status"
                                                    <?php echo $items[0]['active_status'] == "awaiting" ? 'disabled' : '' ?>>
                                                    <option value=''>Select Status</option>
                                            ...
                                            <div class="col-md-3">
                                                <select id='deliver_by' name='deliver_by' class='form-control'
                                                    ...
                                                    <option value="<?= $row['user_id'] ?>"><?= $row['username'] ?>
                                                    </option>
                                                    <?php  } ?>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="edit_order_tracking btn btn-success btn-xl "
                                                    title="Order Tracking"
                                                    data-order_id=' <?= $order_detls[0]['id']; ?>'
                                                    data-target="#transaction_modal" data-toggle="modal"
                                                    style="height:35px;width:38px;"><i
                                                        class="fa fa-map-marker-alt"></i></a>
                                                <a href="javascript:void(0);" title="Bulk Update"
                                                    data-id=' <?= $sellers[$i] ?> '
                                                    class="btn btn-primary ml-3 update_status_admin_bulk">
                                                    Update
                                                </a>
                                                <?php if ($shipping_method['shiprocket_shipping_method'] == 1) { ?>
                                                <button type="button" disabled
                                                    class="btn btn-primary ml-3 col-md-6 create_shiprocket_order float-right"
                                        ...
                                        <p>
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target="#ShiprocketOrderFlow">How to manage shiprocket order
                                            </button>
                                        </p>
                                        <?php } ?>
                                                ...
                                                <div class="card card-info mb-3 mt-2 ">
                                                    <div class="card-body">
                                                        <div class="col-md-6 m-2 text-left">
                                                            ...
                                                            <span
                                                                class="badge badge-danger"><?= isset($order_caharges_data[0]['otp']) ? $order_caharges_data[0]['otp'] : $seller_otp ?></span>
                                                            </p>
                                                            <?php } ?>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-0 ml-4 m-2 text-left mt-3 ">
                                                                ...
                                                                <input type="radio" name="pickup_location"
                                                                    class="check_create_order"
                                                                    data-id="<?= $sellers[$i] ?>"
                                                                    id="<?php print_r($pickup_location[$j]); ?>" />
                                                                <?php } ?>
                                                            </div>
                                                        ...
                                                        <div class="row m-2 ml-6">
                                                            ...
                                                            <div class="col-md-1">
                                                                <span class="badge bg-primary ml-1">Order not
                                                                    created</span>
                                                            </div>
                                                            <?php }
                                                                        } ?>
                                                            ...
                                                            <div class="col-md-1">
                                                                <span class="badge bg-danger ml-1">Order
                                                                    cancelled</span>
                                                            </div>
                                                            <?php  } ?>
                                                            <div class="col-md-5">
                                                                ...
                                                                <a href="" title="Generate AWB"
                                                                    class="btn btn-primary btn-xs mr-1 generate_awb"
                                                                    data-fromadmin="1"
                                                                ...
                                                                <a href="" title="Generate Label"
                                                                    class="btn btn-primary btn-xs mr-1 generate_label"
                                                                    data-fromadmin="1"
                                                                    name=<?php print_r($order_tracking_data[0]['shipment_id']); ?>><i
                                                                ...
                                                                <a href="" title="Generate Invoice"
                                                                    class="btn btn-primary btn-xs mr-1 generate_invoice"
                                                                    data-fromadmin="1"
                                                                    name=<?php print_r($order_tracking_data[0]['shiprocket_order_id']); ?>><i
                                                                ...
                                                                <a href="https://shiprocket.co/tracking/<?php echo $order_tracking_data[0]['awb_code']; ?>"
                                                                    ...
                                                                    class="btn btn-primary action-btn btn-xs mr-1 track_order"
                                                                    name=<?php print_r($order_tracking_data[0]['shiprocket_order_id']); ?>><i
                                                        ...
                                                        <div class="container-fluid">
                                                            ...
                                                            <div
                                                                class=" card col-md-3 col-sm-12 p-3 mb-2 bg-white rounded m-1 grow">
                                                                <div class="row m-2">
                                                                </div>
                                                                <div class="mb-2">
                                                                    <input type="checkbox" id="<?= $sellers[$i] ?>"
                                                                        name="order_item_id"
                                                                ...
                                                                <?php } ?>
                                                                <div><span class="text-bold">Name :
                                                                    </span><small><?= $item['pname'] ?> </small></div>
                                                                <div><span class="text-bold">Quantity :
                                                                    </span><?= $item['quantity'] ?> </div>
                                                                <!-- <div><span class="text-bold">Price : </span><?= $item['price'] + $item['tax_amount'] ?></div> -->
                                                                <div><span class="text-bold">Price :
                                                                    </span><?= $item['price'] ?></div>
                                                                ...
                                                                <div><span class="text-bold">Updated By :
                                                                    </span><?= $item['updated_by'] ?> </div>
                                                                <?php } ?>
                                                                <?php if (isset($item['deliver_by'])) { ?>
                                                                <div><span class="text-bold">Deliver By :
                                                                    </span><?= $item['deliver_by'] ?> </div>
                                                                <?php } ?>
                                                                <div><span class="text-bold">Active Status : </span>
                                                                    <span
                                                                        class="badge ml-1 badge-<?= $badges[$item['active_status']] ?>">
                                                                        <small><?= str_replace('_', ' ', $item['active_status']) ?></small></span>
                                                                </div>
                                                                <div><span class="text-bold">View Product : </span> <a
                                                                        href=" <?= BASE_URL('admin/product/view-product?edit_id=' . $item['product_id'] . '') ?> "
                                                                        title="View Product"
                                                                        class="btn action-btn ml-1 btn-primary btn-xs">
                                                                        <i class="fa fa-eye"></i>
                                                                    </a></div>
                                                                ...
                                                                <div class="row mb-1 mt-1 order_item_mail_status">
                                                                    ...
                                                                    <div
                                                                        class="col-md-1 mr-1 d-flex align-items-center">
                                                                        <a href="javascript:void(0);"
                                                                            title="Update status"
                                                                            data-id=' <?= $item['id'] ?> '
                                                                            class="btn btn-primary btn-xs action-btn ml-1 update_mail_status_admin mr-1">
                                                                            <i class="far fa-arrow-alt-circle-up"></i>
                                                                        </a>
                                                                    </div>
                                                                    <div
                                                                        class="col-md-1 d-flex ml-1 align-items-center">
                                                            ...
                                                            <i class="fas fa-paper-plane"></i>
                                                                        ...
                                                                        <a href="javascript:void(0)"
                                                                            class="btn action-btn btn-warning btn-xs "
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=<?= $item['user_email'] ?>"
                                                                            class="btn action-btn btn-danger btn-xs"
                                                                            target="_blank">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $order_detls[0]['address'] .  ' ,Mobile- ' . $address_number[0]['mobile']; ?>
                                    </td>
                                </tr>
                                <tr>
