                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-info">
                                            ...
                                            <form class="form-horizontal " id="order_tracking_form"
                                                action="<?= base_url('seller/orders/update-order-tracking/'); ?>"
                                        ...
                                        <form id="update_form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-2">
                                                    <lable class="badge badge-success">Select status which you want to
                                                        update</lable>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="javascript:void(0);" title="Bulk Update"
                                                        data-seller_id="<?= $items[0]['seller_id'] ?>"
                                            ...
                                            <p>
                                                <lable class="badge badge-warning mt-2" style="font-size:13px;">Note :
                                                    Select square box of item only when you want to update it as
                                                    cancelled or returned.</lable>
                                            </p>
                                            <?php } else { ?>
                                            <div class="col-md-12 mb-2">
                                                <lable class="badge badge-success">Select status
                                                    <?= get_seller_permission($seller_id, 'assign_delivery_boy') ? 'and delivery boy' : '' ?>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-md-6">
                                                    <a href="javascript:void(0)"
                                                        class="edit_order_tracking btn btn-success btn-xl col-md-1"
                                                    ...
                                                    <a href="javascript:void(0);" title="Bulk Update"
                                                        data-seller_id="<?= $items[0]['seller_id'] ?>"
                                                        class="btn btn-primary ml-1 update_status_admin_bulk">
                                                        Update
                                                    </a>
                                                    <?php if ($shipping_method['shiprocket_shipping_method'] == 1) { ?>
                                                    <button type="button" disabled
                                                        class="btn btn-primary ml-1 col-md-6 create_shiprocket_order"
                                            ...
                                            <p><span class="text-bold">Item OTP : </span><span
                                                    class="badge badge-warning"><?= $items[0]['item_otp']; ?></span></p>
                                            <?php } elseif ($items[0]['seller_otp'] != 0) { ?>
                                            <p><span class="text-bold">Item OTP : </span><span
                                                    class="badge badge-warning"><?= $items[0]['seller_otp']; ?></span>
                                            </p>
                                            <?php }
                                                } ?>
                                            <?php } ?>
                                            ...
                                            <div class="row m-2 ml-6">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <a href="<?php print_r($order_tracking_data[0]['invoice_url']); ?>"
                                                        data-fromseller="1" title="Download Invoice"
                                            ...
                                            <div class="  card col-md-3 col-sm-12 p-3 mb-2 bg-white rounded m-1 grow">
                                                <div class="mb-2">
                                                    <input type="checkbox" id="<?= $sellers[$i] ?>" name="order_item_id"
                                                        value=' <?= $item['id'] ?> '>
                                                </div>
                                                ...
                                                <div><span class="text-bold">Active Status : </span> <span
                                                        class="badge badge-<?= $badges[$item['active_status']] ?>">
                                                        <small><?= str_replace('_', ' ', $item['active_status']) ?></small></span>
                                                </div>
                                                <div><span class="text-bold">View Product : </span> <a
                                                        href=" <?= BASE_URL('seller/product/view-product?edit_id=' . $item['product_id'] . '') ?> "
                                                        title="View Product" class="btn btn-primary btn-xs">
                                                        <i class="fa fa-eye"></i>
                                                    </a></div>
                                                ...
                                                <div class="row mb-1 mt-1 order_item_mail_status">
                                                    ...
                                                    <div class="col-md-1 d-flex ml-1 align-items-center">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            data-target="#sendMailModal" data-toggle="modal"
                                                    ...
                                                    <div class="col-md-1 d-flex ml-1 align-items-center">
                                                        <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=<?= $item['user_email'] ?>"
                                                            class="btn action-btn btn-danger btn-xs" target="_blank">
